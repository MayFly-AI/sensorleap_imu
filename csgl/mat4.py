...
class mat4(object):
    ...
    def rotateX(self,rad):
        self._data[5] = math.cos(rad)
        self._data[6] = math.sin(rad)
        self._data[9] = -math.sin(rad)
        self._data[10] = math.cos(rad)

    def rotateY(self,rad):
        self._data[0] = math.cos(rad)
        self._data[2] = -math.sin(rad)
        self._data[8] = math.sin(rad)
        self._data[10] = math.cos(rad)

    def rotateZ(self,rad):
        self._data[0] = math.cos(rad)
        self._data[1] = -math.sin(rad)
        self._data[4] = math.sin(rad)
        self._data[5] = math.cos(rad)
